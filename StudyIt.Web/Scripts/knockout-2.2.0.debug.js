...
(function () {
    ...
    function applyBindingsToNodeInternal (node, bindings, viewModelOrBindingContext, bindingContextMayDifferFromDomParentElement) {
        ...
        var bindingHandlerThatContStudyItDescendantBindings;
                    ...
                    if (initPhase === 0) {
                        ...
                        for (var bindingKey in parsedBindings) {
                            ...
                            if (binding && typeof binding["init"] == "function") {
                                ...
                                if (initResult && initResult['contStudyItDescendantBindings']) {
                                    if (bindingHandlerThatContStudyItDescendantBindings !== undefined)
                                        throw new Error("Multiple bindings (" + bindingHandlerThatContStudyItDescendantBindings + " and " + bindingKey + ") are trying to control descendant bindings of the same element. You cannot use these bindings together on the same element.");
                                    bindingHandlerThatContStudyItDescendantBindings = bindingKey;
                                }
                            }
                        }
                        initPhase = 2;
        ...
        return {
            shouldBindDescendants: bindingHandlerThatContStudyItDescendantBindings === undefined
        };
    };
...
ko.bindingHandlers['html'] = {
    'init': function() {
        ...
        return { 'contStudyItDescendantBindings': true };
    },
    'update': function (element, valueAccessor) {
